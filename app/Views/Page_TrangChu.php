...
<?php
 ...
 $data_baiDangCHuyenMucChinhSachVanBan['ds_baiDang'] =  $baiDangCHuyenMucChinhSachVanBan;
 $data_baiDangCHuyenMucChinhSachVanBan['url_cate'] = '/cate/trung-tam-giao-duc-nghe-nghiep-phu-nu';
 echo view('block/block_chuyenMuc',$data_baiDangCHuyenMucChinhSachVanBan);
 ?>
...
<?php
 ...
 $data_baiDangCHuyenMucChinhSachVanBan['ds_baiDang'] =  $baiDangCHuyenMucChinhSachVanBan;
 $data_baiDangCHuyenMucChinhSachVanBan['url_cate'] = '/cate/binh-dang-gioi';
 echo view('block/block_chuyenMuc',$data_baiDangCHuyenMucChinhSachVanBan);
 ?>

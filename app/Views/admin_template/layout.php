<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet"
        href="<?= base_url('public/assets/admin_template/plugins/fontawesome-free/css/all.min.css'); ?>">
    ...
    <link rel="stylesheet"
        href="public/assets/admin_template/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- iCheck -->
    ...
    .main-footer {
        height: 3rem;
        background: linear-gradient(45deg, #343a40, #4e555b);
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="admin" class="brand-link">
                <img src="<?= !empty($logo) ? base_url("upload/media/images/$logo") : '' ?>" alt="Logo website"
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="public/assets/admin_template/dist/img/user8-128x128.jpg"
        ...
        <footer class="main-footer">
            ...
            <div class="float-right">
                ...
                @<?php echo $nam ?> - Do <a href="http://ctict.cantho.gov.vn" target="_blank">CTICT</a> xây dựng và
                thiết kế
            </div>
        </footer>
    ...
    <script src="public/assets/admin_template/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js">
    </script>
    <!-- Summernote -->

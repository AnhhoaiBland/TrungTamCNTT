    ...
    <div class="container p-4 bg-body">
        <div class="row">
            <div class="col-md-12 text-center">
                <span class="block_title-gop-y">THƯ GÓP Ý TRUNG TÂM CÔNG NGHỆ THÔNG TIN VÀ TRUYỀN THÔNG THÀNH PHỐ CẦN
                    THƠ</span>
            </div>
        ...
        <form class="row" action="gop-y/add" method="post" enctype="multipart/form-data"> <!-- Added enctype -->
            <div class="col-md-5">
                <div class="mb-3">
                    <input type="text" class="form-control custom-input" name="hoten" id="hoTen" placeholder="Họ và tên">
                </div>
                <div class="mb-3">
                    <input type="text" class="form-control custom-input" name="dienThoai" required
                        placeholder="Số điện thoại" id="dienThoai" onkeypress="return onlyNumbers(event)">
                    <p id="errorMessage" class="text-danger" style="display: none;">Vui lòng nhập vào là số điện thoại</p>
                </div>
                <div class="mb-3">
                    <input type="email" class="form-control custom-input" name="emailgy" id="emailgy"
                        placeholder="Email">
                </div>
                <div class="mb-3">
            ...
            <div class="col-md-7">
                <div class="mb-3">
                    <input type="text" class="form-control custom-input" name="tieuDe" id="tieuDe" required
                        placeholder="Tiêu đề">
                </div>
                <div class="mb-3">
            <label for="summernote" class="form-label">Nội dung</label>
            <div id="summernote"></div>
            <input type="hidden" id="noiDungHidden" name="noiDung">
        </div>
            </div>
            <div class="col-md-12 mb-3">
                <div class="g-recaptcha" data-sitekey="YOUR_SITE_KEY"></div> <!-- reCAPTCHA widget -->
            </div>
